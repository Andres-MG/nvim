...
_G.packer_plugins = {
  ...
  ["julia-vim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "C:\\Users\\andre\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\julia-vim",
  ...
  ["spaceless.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "C:\\Users\\andre\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\spaceless.nvim",
...
vim.cmd [[noremap <silent> <Space>g <cmd>lua require("packer.load")({'telescope.nvim'}, { keys = "<lt>Space>g", prefix = "" }, _G.packer_plugins)<cr>]]
